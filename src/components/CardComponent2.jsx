...
function CardComponent({fir}) {
  ...
  {fir && (fir.map((fir)=>{
if((fir.isapproved==true && fir.isresolved==true) || (fir.isapproved==false && fir.isexits==false)){
     return (      
<Card style={{ width: '18rem',margin: '10px', padding:'15px' }}   text={'primary' === 'light' ? 'white' : 'dark'}  border='info'>
